"""Harbor domain transform234 — consolidated module."""
...
router = APIRouter(prefix="/domains/transform234", tags=["transform234"])
...
def health() -> Dict[str, str]:
    return {"domain": "transform234", "status": "up"}
