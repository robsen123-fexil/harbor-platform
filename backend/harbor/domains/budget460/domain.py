"""Harbor domain budget460 — consolidated module."""
...
router = APIRouter(prefix="/domains/budget460", tags=["budget460"])
...
def health() -> Dict[str, str]:
    return {"domain": "budget460", "status": "up"}
