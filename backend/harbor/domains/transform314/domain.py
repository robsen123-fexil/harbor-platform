"""Harbor domain transform314 — consolidated module."""
...
router = APIRouter(prefix="/domains/transform314", tags=["transform314"])
...
def health() -> Dict[str, str]:
    return {"domain": "transform314", "status": "up"}
